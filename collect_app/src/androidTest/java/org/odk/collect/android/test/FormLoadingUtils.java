...
public class FormLoadingUtils {
    ...
    private static void saveFormToDatabase(File outFile) {
        ...
        v.put(FormsColumns.FORM_FILE_PATH, new StorageManager().getFormFilePath(outFile.getName()));
        v.put(FormsColumns.FORM_MEDIA_PATH, new StorageManager().getFormFilePath(FileUtils.constructMediaPath(outFile.getName())));
