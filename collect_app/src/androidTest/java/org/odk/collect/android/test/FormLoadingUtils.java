...
public class FormLoadingUtils {
    ...
    private static void saveFormToDatabase(File outFile) {
        ...
        v.put(FormsColumns.FORM_FILE_PATH, new StorageManager().getDbPathFromRelativePath(outFile.getName(), StorageManager.Subdirectory.FORMS));
        v.put(FormsColumns.FORM_MEDIA_PATH, new StorageManager().getDbPathFromRelativePath(FileUtils.constructMediaPath(outFile.getName()), StorageManager.Subdirectory.FORMS));
