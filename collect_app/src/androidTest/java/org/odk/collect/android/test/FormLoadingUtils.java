...
public class FormLoadingUtils {
    ...
    private static void saveFormToDatabase(File outFile) {
        ...
        v.put(FormsColumns.FORM_FILE_PATH, new StorageManager().getFormFilePathToStoreInDatabaseBasingOnRelativePath(outFile.getName()));
        v.put(FormsColumns.FORM_MEDIA_PATH, new StorageManager().getFormFilePathToStoreInDatabaseBasingOnRelativePath(FileUtils.constructMediaPath(outFile.getName())));
