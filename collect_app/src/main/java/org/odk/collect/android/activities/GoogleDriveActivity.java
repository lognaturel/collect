...
public class GoogleDriveActivity extends FormListActivity implements View.OnClickListener,
    ...
    private class GetFileTask extends
            ...
            for (int k = 0; k < fileItems.size(); k++) {
                ...
                try {
                    ...
                    if (folderId != null) {
                        ...
                        FileUtils.createFolder(new StorageManager().getAbsolutePath(StorageManager.Subdirectory.FORMS) + File.separator + mediaDirName);
        ...
        private void downloadFile(@NonNull String fileId, String fileName) throws IOException {
            File file = new File(new StorageManager().getAbsolutePath(StorageManager.Subdirectory.FORMS) + File.separator + fileName);
