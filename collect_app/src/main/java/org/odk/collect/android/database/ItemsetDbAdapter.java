...
public class ItemsetDbAdapter {
    ...
    public boolean createTable(String formHash, String pathHash, String[] columns, String relativeCsvFilePath) {
        ...
        cv.put(KEY_PATH, new StorageManager().getFormFilePathToStoreInDatabaseBasingOnRelativePath(relativeCsvFilePath));
    ...
    public void dropTable(String pathHash, String relativeCsvFilePath) {
        ...
        String[] whereArgs = {
                new StorageManager().getFormFilePathToStoreInDatabaseBasingOnRelativePath(relativeCsvFilePath)
        };
