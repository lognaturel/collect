...
public class ItemsetDbAdapter {
    ...
    public boolean createTable(String formHash, String pathHash, String[] columns, String relativeCsvFilePath) {
        ...
        cv.put(KEY_PATH, new StorageManager().getDbPathFromRelativePath(StorageManager.Subdirectory.FORMS, relativeCsvFilePath));
    ...
    public void dropTable(String pathHash, String relativeCsvFilePath) {
        ...
        String[] whereArgs = {
                new StorageManager().getDbPathFromRelativePath(StorageManager.Subdirectory.FORMS, relativeCsvFilePath)
        };
