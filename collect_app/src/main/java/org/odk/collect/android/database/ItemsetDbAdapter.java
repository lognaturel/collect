...
public class ItemsetDbAdapter {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        DatabaseHelper() {
            super(new DatabaseContext(new StorageManager().getAbsolutePath(StorageManager.Subdirectory.METADATA)), DATABASE_NAME, null, DATABASE_VERSION);
        }
    ...
    public boolean createTable(String formHash, String pathHash, String[] columns, String relativeCsvFilePath) {
        ...
        cv.put(KEY_PATH, new StorageManager().getDbPathFromRelativePath(relativeCsvFilePath, StorageManager.Subdirectory.FORMS));
    ...
    public void dropTable(String pathHash, String relativeCsvFilePath) {
        ...
        String[] whereArgs = {
                new StorageManager().getDbPathFromRelativePath(relativeCsvFilePath, StorageManager.Subdirectory.FORMS)
        };
